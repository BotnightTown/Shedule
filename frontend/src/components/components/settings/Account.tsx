  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-row justify-between">
        ...
        <select 
          className={`w-36 p-1 rounded-md border-2 border-gray-300 dark:border-[#02c1eb] focus:outline focus:outline-[#02c1eb] bg-white dark:bg-slate-800 text-sm cursor-pointer`} 
          value={selectedGroup} 
      ...
      <Link to="/change_password" className="text-[#02c1eb] w-max">{t("Change password")}</Link>
